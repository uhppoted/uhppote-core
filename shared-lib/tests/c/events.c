    ...
    const result resultset[] = {
        {
            ...
            .type = "string",
            .value.string.expected = "2022-04-15 12:29:15",
            .value.string.value = event.timestamp,
        },
        {
            .field = "event index",
            .type = "uint32",
            .value.uint32.expected = 51,
            .value.uint32.value = event.index,
        },
        {
            .field = "event type",
            .type = "uint8",
            .value.uint8.expected = 6,
            .value.uint8.value = event.eventType,
        },
        {
            .field = "event granted",
            .type = "boolean",
            .value.boolean.expected = true,
            .value.boolean.value = event.granted,
        },
        {
            .field = "event door",
            .type = "uint8",
            .value.uint8.expected = 3,
            .value.uint8.value = event.door,
        },
        {
            .field = "event direction",
            .type = "uint8",
            .value.uint8.expected = 1,
            .value.uint8.value = event.direction,
        },
        {
            .field = "event card",
            .type = "uint32",
            .value.uint32.expected = 8165538,
            .value.uint32.value = event.card,
        },
        {
            .field = "event reason",
            .type = "uint8",
            .value.uint8.expected = 21,
            .value.uint8.value = event.reason,
        },
    };
