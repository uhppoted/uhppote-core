...
func NewUHPPOTE(bindAddr types.BindAddr, broadcastAddr types.BroadcastAddr, listenAddr net.UDPAddr, timeout time.Duration, devices []Device, debug bool) IUHPPOTE {
