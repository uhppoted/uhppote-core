...
func TestUnmarshalGetCardByIndexResponse(t *testing.T) {
	message := []byte{
		...
		0x20, 0x19, 0x12, 0x29, 0x00, 0x00, 29, 0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}
	...
	if reply.FirstCard != 0x05 {
		t.Errorf("Incorrect 'FirstCard' - expected:%v, got:%v", 0x05, reply.FirstCard)
	}
}
...
func TestUnmarshalGetCardWithPINByIndexResponse(t *testing.T) {
	message := []byte{
		0x17, 0x5c, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0xac, 0xe8, 0x5d, 0x00, 0x20, 0x19, 0x02, 0x03,
		0x20, 0x19, 0x12, 0x29, 0x00, 0x00, 0x1d, 0x01, 0xa4, 0x0d, 0x0f, 0x05, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}
...
func TestUnmarshalGetCardByIndexNotFoundResponse(t *testing.T) {
	...
	if reply.FirstCard != 0x00 {
		t.Errorf("Incorrect 'FirstCard' - expected:%v, got:%v", 0x00, reply.FirstCard)
	}
}
...
func TestUnmarshalGetCardByIdResponse(t *testing.T) {
	message := []byte{
		...
		0x20, 0x19, 0x12, 0x29, 0x00, 0x00, 0x1d, 0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}
...
func TestUnmarshalGetCardWithPINByIdResponse(t *testing.T) {
	message := []byte{
		0x17, 0x5a, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0xac, 0xe8, 0x5d, 0x00, 0x20, 0x19, 0x02, 0x03,
		0x20, 0x19, 0x12, 0x29, 0x00, 0x00, 0x1d, 0x01, 0x16, 0x39, 0x0f, 0x05, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}
