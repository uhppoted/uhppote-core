...
func TestMarshalSetSuperPasswordRequest(t *testing.T) {
	expected := []byte{
	...
	request := SetSuperPasswordRequest{
...
func TestFactoryUnmarshalSetSuperPasswordRequest(t *testing.T) {
	message := []byte{
		0x17, 0x8c, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x03, 0x00, 0x00, 0x00, 0x39, 0x30, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x3f, 0x42, 0x0f, 0x00, 0x31, 0xd4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	rq, ok := request.(*SetSuperPasswordRequest)
	if !ok {
		t.Fatalf("Invalid request type - expected:%T, got: %T", &SetSuperPasswordRequest{}, request)
	}
...
func TestUnmarshalSetSuperPasswordResponse(t *testing.T) {
	message := []byte{
	...
	reply := SetSuperPasswordResponse{}
...
func TestFactoryUnmarshalSetSuperPasswordResponse(t *testing.T) {
	message := []byte{
		0x17, 0x8c, 0x00, 0x00, 0x78, 0x37, 0x2a, 0x18, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	reply, ok := response.(*SetSuperPasswordResponse)
	if !ok {
		t.Fatalf("Invalid response type - expected:%T, got: %T", &SetSuperPasswordResponse{}, response)
	}
...
func TestUnmarshalSetSuperPasswordResponseWithInvalidMsgType(t *testing.T) {
	message := []byte{
