...
func TestMarshalActivateAccessKeypadRequest(t *testing.T) {
	expected := []byte{
		0x17, 0xA4, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0x01, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}

	request := ActivateAccessKeypadRequest{
...
func TestFactoryUnmarshalActivateAccessKeypadRequest(t *testing.T) {
	message := []byte{
		0x17, 0xA4, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0x01, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x020,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}
	...
	rq, ok := request.(*ActivateAccessKeypadRequest)
	if !ok {
		t.Fatalf("Invalid request type - expected:%T, got: %T", &ActivateAccessKeypadRequest{}, request)
	}
...
func TestUnmarshalActivateAccessKeypadResponse(t *testing.T) {
	message := []byte{
		0x17, 0xA4, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}

	reply := ActivateAccessKeypadResponse{}
...
func TestFactoryUnmarshalActivateKeypadResponse(t *testing.T) {
	message := []byte{
		0x17, 0xA4, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	reply, ok := response.(*ActivateAccessKeypadResponse)
	if !ok {
		t.Fatalf("Invalid response type - expected:%T, got: %T\n", &ActivateAccessKeypadResponse{}, response)
	}
...
func TestUnmarshalActivateKeypadResponseWithInvalidMsgType(t *testing.T) {
	message := []byte{
