...
func TestMarshalPutCardRequest(t *testing.T) {
	expected := []byte{
		...
		0x20, 0x19, 0x12, 0x31, 0x01, 0x00, 0x1d, 0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00,
...
func TestMarshalPutCardRequestWithPIN(t *testing.T) {
	expected := []byte{
		0x17, 0x50, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0xac, 0xe8, 0x5d, 0x00, 0x20, 0x19, 0x01, 0x02,
		0x20, 0x19, 0x12, 0x31, 0x01, 0x00, 0x1d, 0x01, 0xd7, 0xe1, 0x0e, 0x05, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}
...
func TestFactoryUnmarshalPutCardRequest(t *testing.T) {
	message := []byte{
		0x17, 0x50, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0xac, 0xe8, 0x5d, 0x00, 0x20, 0x19, 0x01, 0x02,
		0x20, 0x19, 0x12, 0x31, 0x01, 0x00, 29, 0x01, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}
	...
	if rq.FirstCard != 0x05 {
		t.Errorf("Incorrect 'FirstCard' - expected:%v, got:%v", 0x05, rq.FirstCard)
	}
}
...
func TestFactoryUnmarshalPutCardRequestWithPIN(t *testing.T) {
	message := []byte{
		0x17, 0x50, 0x00, 0x00, 0x2d, 0x55, 0x39, 0x19, 0xac, 0xe8, 0x5d, 0x00, 0x20, 0x19, 0x01, 0x02,
		0x20, 0x19, 0x12, 0x31, 0x01, 0x00, 0x1d, 0x01, 0xd1, 0x2f, 0x0d, 0x05, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	}
