...
func TestSegmentsMarshalJSONWithOutOfRangeSegments(t *testing.T) {
	expected := []byte(`[{"start":"08:30","end":"09:45"},{"start":"11:35","end":"14:15"},{"start":"15:10","end":"18:00"}]`)
...
func TestSegmentsUnmarshalJSONWithEmptySegment(t *testing.T) {
	expected := Segments{
		1: Segment{Start: hhmm("08:30"), End: hhmm("09:45")},
		2: Segment{},
		3: Segment{Start: hhmm("15:10"), End: hhmm("18:00")},
...
func TestSegmentsUnmarshalJSONWithLessThan3Segments(t *testing.T) {
	expected := Segments{
		1: Segment{Start: hhmm("08:30"), End: hhmm("09:45")},
...
func TestSegmentsUnmarshalJSONWithMoreThan3Segments(t *testing.T) {
	expected := Segments{
		1: Segment{Start: hhmm("08:30"), End: hhmm("09:45")},
		2: Segment{Start: hhmm("11:35"), End: hhmm("14:15")},
		3: Segment{Start: hhmm("15:10"), End: hhmm("18:00")},
	...
	if err := json.Unmarshal([]byte(`[ {"start":"08:30", "end":"09:45"},{"start":"11:35","end":"14:15"},{"start":"15:10","end":"18:00"},{"start":"19:30","end":"20:30"} ]`), &segments); err != nil {
		t.Fatalf("Error unmarshalling segments (%v)", err)
	}
